    ...
    def _start_processing(self):
        ...
        try:
            ...
            if not os.path.exists(target_cfd_path):
                ...
                source_cfd_path = "/home/cfduser/Desktop/CFD_GUI/User_Data/amatos/Qadra Hussein/Test/CFD_40_0"
        ...
        if stage == "segmentation":
            segmentation_button = ctk.CTkButton(
                ...
                command=lambda: self._display_interactive_stl(
                    "/home/cfduser/Desktop/CFD_GUI/User_Data/amatos/Qadra Hussein/Test/stl/P5T1.stl"),
                width=350,
                height=40,
                font=UI_SETTINGS["FONTS"]["BUTTON_TEXT"],
                fg_color="#00734d",
